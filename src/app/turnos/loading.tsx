...
// Skeleton de turnos: header + navegador de día + tarjetas de turno (hora,
// cliente, servicio, estado), misma estructura que la página real.
            ...
            <li className="rounded-2xl border border-slate-200 p-3.5" key={index}>
              <div className="flex flex-wrap items-start justify-between gap-3">
                <div className="min-w-0">
                  ...
                  <Skeleton className="mt-1.5 h-3 w-2/3 max-w-52" />
                </div>
