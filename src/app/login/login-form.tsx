    ...
    <form className="grid gap-5" noValidate onSubmit={handleSubmit}>
      <div className="grid gap-4">
        <label className="grid gap-2 text-sm font-black text-slate-700" htmlFor="email">
          Email o usuario
          <span className="flex min-h-14 items-center gap-3 rounded-2xl border-2 border-slate-200 bg-slate-50 px-4 transition focus-within:border-primary focus-within:ring-4 focus-within:ring-primary/15">
        ...
        <button className="mt-1 flex min-h-14 items-center justify-center gap-2 rounded-2xl bg-primary px-4 text-base font-black text-white shadow-sm shadow-primary/25 transition hover:bg-primary-strong active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-60 disabled:hover:bg-primary" disabled={isPending} type="submit">
