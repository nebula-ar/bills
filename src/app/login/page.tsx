      ...
      <section className="flex w-full flex-1 flex-col bg-white px-6 pb-[max(1.5rem,env(safe-area-inset-bottom))] pt-[max(2rem,env(safe-area-inset-top))] sm:min-h-0 sm:max-w-[28rem] sm:flex-none sm:rounded-[2.5rem] sm:px-8 sm:py-10 sm:shadow-2xl sm:shadow-slate-950/15">
        <div className="flex flex-1 flex-col justify-center gap-8 sm:flex-none">
          <div className="grid gap-6 text-center">
            <Link
              className="mx-auto grid size-20 place-items-center rounded-[1.8rem] bg-linear-to-br from-blue-600 to-violet-600 text-3xl font-black tracking-[-0.08em] text-white shadow-lg shadow-primary/30 transition hover:scale-105 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-4 active:scale-95"
              href="/"
            ...
            <div>
              <p className="text-sm font-black tracking-[0.24em] text-primary">BILLS</p>
          ...
          <div className="grid gap-3 text-center text-sm font-semibold text-slate-500">
            <p>
              ¿No tenés cuenta?{" "}
              <Link className="font-black text-primary hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2" href="/register">
                Registrá tu negocio
              </Link>
            </p>
            <Link className="font-bold text-slate-500 hover:text-primary hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2" href="/terminal">
