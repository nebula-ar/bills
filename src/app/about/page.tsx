...
import { Store, Ban, Calculator, Building2 } from "lucide-react";
import { Navbar } from "@/components/landing/Navbar";
import { Footer } from "@/components/landing/footer";
import { MagneticButton } from "@/components/landing/MagneticButton";

export const metadata: Metadata = {
  title: "Sobre Bills — Software de gestión para negocios",
  description:
    "Bills es el sistema de gestión para negocios y peluquerías que reemplaza el Excel: turnos, cobro en la silla, comisiones automáticas y reportes, sin comisión sobre tus ventas.",
};
      ...
      <main className="pt-32 pb-24">
        <section className="max-w-3xl mx-auto px-6">
          ...
          <h1 className="text-4xl lg:text-5xl font-bold font-montserrat mb-6 leading-tight">
            El sistema de gestión para negocios que reemplaza el Excel, no que lo copia.
          </h1>
          <p className="text-lg text-slate-600 leading-relaxed mb-6">
            La mayoría de las negocios y peluquerías en Argentina todavía cierran el día a mano:
            un cuaderno para las ventas, una calculadora para las comisiones y una planilla de Excel
            que nadie termina de actualizar. Bills existe para sacar esas tres cosas del medio.
          </p>
          <p className="text-lg text-slate-600 leading-relaxed">
            Es un sistema de gestión pensado específicamente para negocios: agenda de turnos,
            cobro en la silla desde el celular, cálculo automático de comisiones por empleado y
            reportes ejecutivos por sucursal. Todo en un solo lugar, para que el dueño deje de
            administrar números y el empleado deje de perder tiempo haciendo cuentas.
          </p>
        </section>

        <section className="max-w-3xl mx-auto px-6 mt-16">
          <h2 className="text-2xl lg:text-3xl font-bold font-montserrat mb-8">
            Por qué existe Bills
          </h2>
          <div className="grid sm:grid-cols-2 gap-6">
            <div className="p-6 rounded-2xl bg-white border border-slate-200">
              ...
              <p className="text-slate-600 text-sm leading-relaxed">
                ...
                A medida que tu negocio crece, esa comisión crece con vos. Bills cobra una
            ...
            <div className="p-6 rounded-2xl bg-white border border-slate-200">
              ...
              <p className="text-slate-600 text-sm leading-relaxed">
                Cada venta calcula automáticamente qué le corresponde al empleado y qué a la casa.
            ...
            <div className="p-6 rounded-2xl bg-white border border-slate-200">
              ...
              <p className="text-slate-600 text-sm leading-relaxed">
                Si tenés más de un local, Bills te muestra qué sucursal rinde más, qué
                empleado factura más y dónde poner el foco, sin cruzar planillas a mano.
              </p>
            </div>
            <div className="p-6 rounded-2xl bg-white border border-slate-200">
              <div className="w-11 h-11 rounded-xl bg-red-50 flex items-center justify-center mb-4">
              ...
              <h3 className="font-bold text-lg mb-2 font-montserrat">Hecho para negocios, no adaptado</h3>
              <p className="text-slate-600 text-sm leading-relaxed">
                No es un sistema genérico de turnos con el logo cambiado. Está armado alrededor de
                cómo trabaja realmente una negocio: silla, terminal, comisión, cierre de caja.
              </p>
            </div>
          </div>
        </section>
