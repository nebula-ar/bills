...
export default async function BarberPage({ searchParams }: BarberPageProps) {
  ...
  return (
    <main className="flex min-h-[100dvh] bg-slate-100 px-3 py-4 text-slate-950 sm:px-6 sm:py-8">
      <section className="relative mx-auto flex h-[calc(100dvh-2rem)] w-full max-w-md flex-col overflow-hidden rounded-[2.5rem] bg-white shadow-[0_24px_80px_rgba(15,23,42,0.16)] ring-1 ring-slate-200 sm:h-[calc(100dvh-4rem)]">
