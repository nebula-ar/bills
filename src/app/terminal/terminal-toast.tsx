...
// Debe coincidir con FLASH_COOKIE de "@/lib/terminal-flash" (no lo importamos para no
...
export function StaffToast({ status, message }: { status: "success" | "error"; message: string }) {
