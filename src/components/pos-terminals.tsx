...
import { Check, Copy, Link2, Monitor, Smartphone, X, type LucideIcon } from "lucide-react";
...
export function PosTerminals({ branch }: { branch: { id: string; name: string; barbers: Barber[] } }) {
