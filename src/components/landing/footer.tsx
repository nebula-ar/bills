    ...
    <footer className="bg-[#0A0A0B] pt-16 pb-8 relative z-10 -mt-[1px]">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-16">
          <div className="col-span-2">
            <Link href="/" className="inline-flex items-center gap-2 text-xl font-bold text-white mb-4 font-montserrat">
              <Store className="w-5 h-5 text-[#38BDF8]" />
              Bills
            </Link>
            <p className="text-gray-400 max-w-sm">
              El sistema operativo moderno para negocios ambiciosas. Creado para llenar sillas y automatizar pagos.
            </p>
          </div>
          <div>
        ...
        <div className="pt-8 border-t border-[#1E293B] flex justify-center items-center text-sm text-gray-400">
          <p>© {new Date().getFullYear()} Bills. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  );
