        ...
        <div className="grid min-h-[395px] grid-cols-[88px_1fr] sm:grid-cols-[132px_1fr]">
          <aside className="border-r border-slate-200/80 px-1 py-5 sm:px-2">
            ...
            <div className="space-y-1 text-[10px] font-bold sm:text-[11px]">
              <div className="rounded-lg bg-primary/10 px-2 py-2 text-[var(--primary)]">Resumen</div>
              ...
              {example.activity.map((item) => (
                <div key={item.title} className="flex items-center justify-between gap-2 border-b border-slate-100 py-2 last:border-0">
                  <div className="flex min-w-0 items-center gap-2">
                    <span className="grid h-6 w-6 shrink-0 place-items-center rounded-lg bg-primary/10 text-[10px] font-black text-[var(--primary)]">{item.initials}</span>
              ...
              {rubroExamples.map((example) => {
                ...
                return (
                  <button
                    ...
                    className={`inline-flex min-h-11 items-center gap-2 rounded-full border px-3.5 text-xs font-extrabold transition active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--primary)] focus-visible:ring-offset-2 ${active ? "border-[var(--primary)] bg-[var(--primary)] text-white" : "border-slate-300 text-slate-600 hover:border-[var(--primary)] hover:text-[var(--primary)]"}`}
                  >
